# -*- coding: utf-8 -*-
# Generated by Django 1.11.6 on 2018-05-15 14:44
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('it', 'IT互联网'), ('language', '语言留学'), ('design', '设计'), ('life', '生活兴趣'), ('plant', '生产种植'), ('edu', '升学考研'), ('certificate', '公培考证')], max_length=15, verbose_name='分类')),
            ],
            options={
                'verbose_name': '第一分类',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('teacher_img', models.ImageField(upload_to='img/%Y/%m', verbose_name='老师图')),
                ('teacher_course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='course.Course', verbose_name='课程')),
            ],
            options={
                'verbose_name': '老师',
        ...
        migrations.AddField(
            model_name='chapter',
            name='chapter_course',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='课程', to='course.Course', verbose_name='课程'),
        ),
        migrations.AddField(
            model_name='buy',
            name='course',
